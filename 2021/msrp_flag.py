...
wb = load_workbook(r"templates\msrpflag.xlsx") # create new workbook
ws = wb["2021"]
row = 1
...
for option in sorted(options):
   ...
   # if SHHT == "Y" or if SSOB == "Y"
    ...
    ws.cell(row = row, column = 4).value = options[option]["ADVERTISED RETAIL"]
